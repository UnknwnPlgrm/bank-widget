...
def test_filter_of_bank_operation(example_list_of_operations, ex_passed_list_of_operation, can_passed_list_of_operation):
...
def test_operation_date_sorting(example_list_of_operations, passed_sorting_list_of_operation, reversed_passed_sorting_list_of_operation):
    assert processing.operation_date_sorting(example_list_of_operations, False) == passed_sorting_list_of_operation
    assert processing.operation_date_sorting(example_list_of_operations, True) == reversed_passed_sorting_list_of_operation
