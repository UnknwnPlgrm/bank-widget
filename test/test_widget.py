...
@pytest.mark.parametrize(
    "card_or_check_data, masked_card_or_check_data",
    [
...
def test_mask_multifunction(card_or_check_data: str, masked_card_or_check_data: str) -> None:
...
def test_formatting_data_string(input_data: str, formatted_data: str) -> None:
