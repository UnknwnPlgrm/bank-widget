...
def test_mask_number_of_card(card_number: str, mask_card_number: str) -> None:
    assert mask.mask_number_of_card(card_number) == mask_card_number


@pytest.mark.parametrize(
    "check_number, mask_check_number",
    [
...
def test_mask_check(check_number: str, mask_check_number: str) -> None:
